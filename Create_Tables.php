...
$sql5 = "CREATE TABLE `agrikartdb`.`card details` ( `id` INT NOT NULL AUTO_INCREMENT , `fname` VARCHAR(30) NOT NULL , `email` VARCHAR(40) NOT NULL , `address` VARCHAR(50) NOT NULL , `city` VARCHAR(20) NOT NULL , `state` VARCHAR(20) NOT NULL , `pincode` VARCHAR(6) NOT NULL , `name` VARCHAR(30) NOT NULL , `card_number` VARCHAR(20) NOT NULL , PRIMARY KEY (`id`)) ENGINE = MyISAM";
...
$sql = "INSERT INTO products (name, price, image_link, season, quantity, category) 
          ...
          ('White Marigold Seeds','510', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img55.jpg?raw=true', 'winter', '150','flower'),
          ('Double Dwarf Mix Seeds','540', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img56.jpg?raw=true', 'rainy', '150','flower'),
          ('Salvia Saint Fire Seeds','320', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img57.jpg?raw=true', 'winter', '0','flower'),
          ('Sweet Sultan Mix Seeds','740', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img58.jpg?raw=true', 'rainy', '150','flower'),
          ('Sweet Alyssum White Seeds','100', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img59.jpg?raw=true', 'spring', '0','flower'),
           ...
           ('Agrimate Hedge shear','650', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img10.jpg?raw=true', 'Null', '0', 'tools'),
           ...
           ('Chilli Seeds','110', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img17.jpg?raw=true', 'summer', '0', 'seeds'),
           ...
           ('SpringOnion Seeds','90', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img25.jpg?raw=true', 'winter', '0', 'seeds'),
           ...
           ('Lemon Basil Seeds', '200', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img32.jpg?raw=true','summer','0', 'seeds'),
           ...
           ('Antirrhinum Seeds', '190', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img35.jpg?raw=true', 'rainy', '0', 'flower'),
           ...
           ('Lettuce Seeds', '620', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img47.jpg?raw=true', 'spring', '150', 'seeds'),
           ('WaterMelon Seeds', '250', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img48.jpg?raw=true', 'summer', '150', 'fruit'),
           ('Pappaya Seeds', '350', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img49.jpg?raw=true', 'winter', '150', 'fruit'),
           ('Muskmelon Seeds', '300', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img50.jpg?raw=true', 'winter', '0', 'fruit'),
           ...
           ('Fenugreek Seeds','315', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img60.jpg?raw=true', 'rainy', '150','seeds'),
          ('Black Carrot Seeds','420', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img61.jpg?raw=true', 'winter', '150','seeds'),
          ('Red Cabbage Seeds','300', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img62.jpg?raw=true', 'winter', '150','seeds'),
          ('Iceland Poppy Seeds','400', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img63.jpg?raw=true', 'rainy', '150','flower'),
          ('Celosia Cristata Cocks Comb Seeds','500', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img64.jpg?raw=true', 'spring', '150','flower'),
          ('Lupin Pixie Seeds','320', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img65.jpg?raw=true', 'summer', '0','flower'),
          ('French Marigold orange seeds','420', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img66.jpg?raw=true', 'winter', '150','flower'),
          ('Zinnia Orange seeds','320', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img67.jpg?raw=true', 'summer', '150','flower'),
          ('Amaranthus Pygmy Torch Seeds','320', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img68.jpg?raw=true', 'summer', '150','flower'),
          ('Aster duchess Formula Mix Seeds','340', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img69.jpg?raw=true', 'spring', '150','flower'),
          ('Gaillardia Aristata Tokajer Seeds','310', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img70.jpg?raw=true', 'spring', '0','flower'),
          ('Dahlia Seeds','240', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img71.jpg?raw=true', 'spring', '150','flower'),
          ('Dimorphotheca Pluviali Seeds','420', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img72.jpg?raw=true', 'winter', '150','flower'),
          ('Daisy Seeds','430', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img73.jpg?raw=true', 'winter', '150','flower'),
          ('Schizanthus Angel Wings Seeds','340', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img74.jpg?raw=true', 'spring', '150','flower'),
          ('Vinca Red Cherry Dwarf Seeds','420', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img75.jpg?raw=true', 'summer', '150','flower'),
          ('Vinca Dwarf White Seeds','290', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img76.jpg?raw=true', 'summer', '150','flower'),
          ('Zinnia Dahlia Mix seeds','310', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img77.jpg?raw=true', 'spring', '150','flower'),
          ('Indian Shirley Poppy Mix Seeds','330', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img78.jpg?raw=true', 'winter', '150','flower'),
          ('French Marigold Red Seeds','420', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img79.jpg?raw=true', 'spring', '0','flower'),
          ('Candituft Ebress Alba Seeds','190', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img80.jpg?raw=true', 'summer', '150','flower'),
          ('Blueberry Seeds','700', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img81.jpeg?raw=true', 'rainy', '150','fruit'),
          ('Apple Seeds','290', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img82.jpeg?raw=true', 'spring', '150','fruit'),
          ('Mango Seeds','220', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img83.jpg?raw=true', 'summer', '150','fruit'),
          ('Banana Seeds','200', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img84.jpeg?raw=true', 'rainy', '150','fruit'),
          ('Orange Seeds','190', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img85.jpeg?raw=true', 'rainy', '150','fruit'),
          ('Kiwi Seeds','450', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img86.jpg?raw=true', 'spring', '150','fruit'),
          ('Black Grapes seeds','320', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img87.jpg?raw=true', 'rainy', '150','fruit'),
          ('Green Grapes seeds','290', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img88.png?raw=true', 'rainy', '0','fruit'),
          ('Red Cherry Seeds','800', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img89.jpg?raw=true', 'summer', '150','fruit'),
          ('Watermelon Seeds','100', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img90.jpg?raw=true', 'summer', '150','fruit'),
          ('Muskmelon Seeds','200', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img91.jpeg?raw=true', 'winter', '150','fruit'),
          ('Papaya Seeds','200', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img92.jpg?raw=true', 'rainy', '150','fruit'),
          ('Guava Seeds','250', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img93.jpg?raw=true', 'rainy', '150','fruit'),
          ('Asian Plum Seeds','500', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img94.jpg?raw=true', 'summer', '150','fruit'),
          ('Cranberry Seeds','700', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img95.jpg?raw=true', 'rainy', '150','fruit'),
          ('Pineapple Seeds','220', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img96.jpeg?raw=true', 'Null', '150','fruit'),
          ...
          ('Komugi (Pyriproxyfen 10% EC)','390', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/img100.jpg?raw=true', 'Null', '0','pest'),
          ...
          ('Radish Seeds','150', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/seed1.jpg?raw=true', 'rainy', '150','seeds'),
          ('Bitter Gourd Seeds','200', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/seed2.jpg?raw=true', 'rainy', '150','seeds'),
          ('Tomato Seeds','100' ,'https://github.com/sumitdixit117/AgriKart/blob/main/images/seed3.jpg?raw=true', 'winter', '150','seeds'),
          ...
          ('Trowel','900', 'https://github.com/sumitdixit117/AgriKart/blob/main/images/trowel.jpg?raw=true', 'Null', '0','tools'),
...
if ($conn->query($sql1) === TRUE && $conn->query($sql2) === TRUE && $conn->query($sql3) === TRUE && $conn->query($sql4) === TRUE && $conn->query($sql5) === TRUE && $conn->query($sql) === TRUE) {
