...
<?php require_once('header.php'); ?>
    ...
    <?php
        ...
        $getQuery = "SELECT * FROM `products` WHERE category='tools' LIMIT $initial_page, $limit";     
        ...
        $result = mysqli_query ($conn, $getQuery); ?>
            ...
            if($page_number>=2){   
                ...
                echo "<a href='Tools.php?page=".($page_number-1)."'>  Prev </a>";   
            ...
            for ($i=1; $i<=$total_pages; $i++) {   
                ...
                if ($i == $page_number) {   
                    $pageURL .= "<a class = 'active' href='Tools.php?page=" .$i."'>".$i." </a>";   
                }               

                else  {   
                    $pageURL .= "<a href='Tools.php?page=".$i."'>".$i." </a>";     
                }   
            ...
            if($page_number<$total_pages){   
                ...
                echo "<a href='Tools.php?page=".($page_number+1)."'>  Next </a>";   
...
<script>
    ...
    {   
        ...
        window.location.href = 'Tools.php?page='+page;   
    }   
</script>
