    ...
    <?php
        ...
        $result = mysqli_query ($conn, $getQuery); ?>
            ...
            if($page_number>=2){   
                ...
                echo "<a href='Pest.php?page=".($page_number-1)."'>  Prev </a>";   
            ...
            for ($i=1; $i<=$total_pages; $i++) {   
                ...
                if ($i == $page_number) {   
                    $pageURL .= "<a class = 'active' href='Pest.php?page=" .$i."'>".$i." </a>";   
                }               

                else  {   
                    $pageURL .= "<a href='Pest.php?page=".$i."'>".$i." </a>";     
                }   
            ...
            if($page_number<$total_pages){   
                ...
                echo "<a href='Pest.php?page=".($page_number+1)."'>  Next </a>";   
...
<script>
    ...
    {   
        ...
        window.location.href = 'Pest.php?page='+page;   
    }   
</script>
